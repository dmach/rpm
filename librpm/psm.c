...
#include "librpm/fsm.h"		/* XXX CPIO_FOO/FSM_FOO constants */
#include "librpm/rpmchroot.h"
#include "librpm/rpmfi_internal.h" /* XXX replaced/states... */
#include "librpm/rpmte_internal.h"	/* XXX internal apis */
#include "librpm/rpmdb_internal.h" /* rpmdbAdd/Remove */
#include "librpm/rpmts_internal.h" /* rpmtsPlugins() etc */
#include "librpm/rpmds_internal.h" /* rpmdsFilterTi() */
#include "librpm/rpmscript.h"
#include "librpm/misc.h"
#include "librpm/rpmtriggers.h"

#include "librpm/rpmplugins.h"
