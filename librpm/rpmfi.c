...
#include "librpm/rpmfi_internal.h"
#include "librpm/rpmte_internal.h"	/* relocations */
#include "librpm/cpio.h"	/* XXX CPIO_FOO */
#include "librpm/fsm.h"	/* rpmpsm stuff for now */
#include "librpm/rpmug.h"
#include "librpmio/rpmio_internal.h"       /* fdInit/FiniDigest */
