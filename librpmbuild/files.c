...
#include "librpmio/rpmio_internal.h"	/* XXX rpmioSlurp */
#include "misc/rpmfts.h"
#include "librpm/rpmfi_internal.h"	/* XXX fi->apath */
#include "librpm/rpmug.h"
#include "librpmbuild/rpmbuild_internal.h"
#include "librpmbuild/rpmbuild_misc.h"
